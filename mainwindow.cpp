...
void MainWindow::on_btn_ligarValvula()
{
    //colocar para acionar bomba manualmente
}

void MainWindow::on_btn_desligarValvula()
{
    //colocar para desacionar bomba manualmente
}

void MainWindow::dadosRecebidos()
{
    //colocar aqui on ou off caso esteja funcionando de forma automatica
}

bool MainWindow::dadosRecebidos_1()
{
        //colocar aqui on ou off caso esteja funcionando de forma manual
}
